// src/components/widgets/TimeChartWidget.jsx
...
const options = {
  chart: {
    ...
    // Set chart height to fill its container
    height: '30%'
  },
  credits: {
    enabled: false
  ...
  tooltip: {
    ...
    pointFormat: '<span style="color:{point.color}">\u25CF</span> {point.x:%e. %b %Y}: {point.y:.2f} m'
  },
  legend: {
    itemStyle: {
      color: 'white',
